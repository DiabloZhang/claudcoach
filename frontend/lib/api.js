...
export const api = {
  ...
  coachConversations: () => apiFetch('/coach/conversations'),
  coachConversation: (convId) => apiFetch(`/coach/conversations/${convId}`),
  coachProcessTopics: (convId) => apiPost(`/coach/conversations/${convId}/process-topics`, {}),
